...
export const UICustomizations = {
  ...
  SearchHRMSConfig:{
    ...
    preProcess: (data) => {
      console.log("dfguh");
      console.log(data.state.searchForm.name);
      data.params = { ...data.params, tenantId: Digit.ULBService.getCurrentTenantId(), codes: data.state.searchForm.name};
    ...
    additionalCustomizations: (row, key, column, value, t, searchResult) => {
      ...
      console.log(key," kkkkkkkkkkkkkkkkkkkk");
      console.log(row?.user?.roles.length);
      switch (key) {
        ...
        case "No of Roles":
          return <span style={{ whiteSpace: "nowrap" }}>{row?.user?.roles?.length}</span>;
  ...
  SearchWageSeekerConfig:  {
    ...
    preProcess: (data) => {
      console.log("dfguh");
      data.params = { ...data.params, tenantId: Digit.ULBService.getCurrentTenantId(), codes:"BHAVYA" };
