...
import searchFireNocConfig from "../../configs/searchFireNocConfig";
...
const FireNocSearch = () => {
  ...
  const indConfigs = searchFireNocConfig();
  ...
  // const data = searchWageSeekerConfig;
