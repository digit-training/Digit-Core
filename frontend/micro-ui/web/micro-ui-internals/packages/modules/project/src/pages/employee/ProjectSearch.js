...
import searchProjectConfig from "../../configs/searchProjectConfig";
...
const SearchProject = () => {
  ...
  const indConfigs = searchProjectConfig();
...
console.log(indConfigs);
  ...
  useEffect(() => {
    if (!window.location.href.includes("modify-project") && sesionFormData && Object.keys(sesionFormData) != 0) {
