...
export const UICustomizations = {
  ...
  AttendanceInboxConfig: {
    ...
    populateReqCriteria: () => {
      ...
      return {
        ...
        params: { limit: 50, offset: 0 , tenantId: "pb.amritsar"},
        body: {
          SearchCriteria: {
            tenantId: tenantId,
            functions : {
  ...
  SearchTLConfig:  {
    ...
    preProcess: (data) => {
      console.log(data, " hjdgsgfffffffffffffffhj")
      data.params = { ...data.params, tenantId: "pb.amritsar" };
